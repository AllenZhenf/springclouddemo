package com.szf.microservicesimpleprovideruser.controller;

import com.szf.microservicesimpleprovideruser.dao.UserRepository;
    ...
    public User findById(@PathVariable Long id){
        ...
        if(principal instanceof UserDetails){
            ...
            for(GrantedAuthority c:collection){
                LOGGER.info("{}:{}", userDetails.getUsername(),c.getAuthority());
            }
        }else{}
